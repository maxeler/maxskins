...
public class MovingAverageClient {
    ...
    public static void main (String [] args) {
        ...
        try {
            ...
            MovingAverage_actions_t_struct action = new MovingAverage_actions_t_struct(size, address_dataIn, address_dataOut);
            long address_action = client.send_MovingAverage_actions_t(action);
