...
/** VectorAddition BasicStatic example. */
public final class VectorAdditionClient {
  ...
  public static List<Integer> vectorAdditionDfe(
    ...
    try {
      ...
      client.VectorAddition_writeLMem(0, sizeBytes, addressFirstVector);
      estimatedTime = (System.nanoTime() - startTime) / NUM_OF_NANO_SECONDS;
      ...
      // Action default
      startTime = System.nanoTime();
      client.VectorAddition(scalar, size, addressSecondVector, addressDataOut);
      estimatedTime = (System.nanoTime() - startTime) / NUM_OF_NANO_SECONDS;
