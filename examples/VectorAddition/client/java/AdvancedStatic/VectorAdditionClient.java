...
import com.maxeler.VectorAddition.VectorAddition_actions_t_struct;
import com.maxeler.VectorAddition.VectorAddition_writeLMem_actions_t_struct;
...
/** VectorAddition AdvancedStatic example. */
public final class VectorAdditionClient {
  ...
  public static List<Integer> vectorAdditionDfe(
    ...
    try {
      ...
      VectorAddition_writeLMem_actions_t_struct actionLmem =
          new VectorAddition_writeLMem_actions_t_struct(0, sizeBytes,
                                                        addressFirstVector);
      final long addressActionLmem =
          client.send_VectorAddition_writeLMem_actions_t(actionLmem);
      client.VectorAddition_writeLMem_run(engine, addressActionLmem);
      estimatedTime = (System.nanoTime() - startTime) / NUM_OF_NANO_SECONDS;
      ...
      // Action default
      startTime = System.nanoTime();
      VectorAddition_actions_t_struct action =
          new VectorAddition_actions_t_struct(scalar, size,
                                              addressSecondVector,
                                              addressDataOut);
      final long addressAction = client.send_VectorAddition_actions_t(action);
      client.VectorAddition_run(engine, addressAction);
      estimatedTime = (System.nanoTime() - startTime) / NUM_OF_NANO_SECONDS;
