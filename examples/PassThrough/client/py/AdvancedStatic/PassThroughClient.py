...
from com.maxeler.PassThrough.ttypes import PassThrough_actions_t_struct
...
def pass_through_dfe(size, data_in):
    ...
    try:
        ...
        # Action default
        start_time = time.time()
        actions = PassThrough_actions_t_struct(size, address_data_in,
                                               address_data_out)
        address_actions = client.send_PassThrough_actions_t(actions)
        client.PassThrough_run(max_engine, address_actions)
