...
public class PassThroughClient {
	...
	try {
	    ...
	    // Initialize maxfile
            long maxfile = client.PassThrough_init();
	    ...
	    PassThrough_actions_t_struct action = new PassThrough_actions_t_struct(size, address_dataIn, address_dataOut);
            long address_action = client.send_PassThrough_actions_t(action);
