...
void CorrelateDFE (double** data, uint64_t sizeTimeseries, uint64_t numTimeseries, double* correlations) {
  ...
  try {
    ...
    int test = client.max_get_offset_auto_loop_size(actions, "CorrelationKernel", "loopLength");
    ...
    client.max_queue_input(actions, "in_precalculations", addressPrecalculations,
			   2 * numTimeseries * numTimesteps * sizeof(double));
    ...
    client.max_queue_output(actions, "out_correlation", addressOutCorrelation,
			   (numTimesteps * loopLength.at(0) * correlationNumTopScores * correlationNumPipes +
			    numBursts * 24) * sizeof(double));  // for anything other than ISCA 48 should be instead of 24
    client.max_queue_output(actions, "out_indices", addressOutIndices,
			   2 * numTimesteps * loopLength.at(0) *
			   correlationNumTopScores * correlationNumPipes * sizeof(int32_t));
    ...
    client.receive_data_double(outCorrelation,
			       ...
			       correlationNumTopScores * correlationNumPipes + numBursts * 48);
