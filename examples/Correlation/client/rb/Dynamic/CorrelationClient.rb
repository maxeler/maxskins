...
def correlate_dfe(data, size_timeseries, num_timeseries, correlations)
  ...
  actions = client.max_actions_init(maxfile, 'loadLMem')
  client.max_set_param_uint64t(actions, 'numBursts', num_bursts)
  client.max_get_offset_auto_loop_size(actions, 'CorrelationKernel',
                                       'loopLength')
  client.max_queue_input(actions, 'in_memLoad', address_in_mem_load,
  ...
  client.max_queue_input(
    actions, 'in_precalculations', address_precalculations,
  ...
  client.max_queue_output(
    actions, 'out_correlation', address_out_correlation,
    (num_timesteps * loop_length[0] * CORREALTION_NUM_TOP_SCORES *
     CORREALTION_NUM_PIPES + num_bursts * 24) * 8)
  # for anything other than ISCA 48 should be instead of 24
  client.max_queue_output(actions, 'out_indices', address_out_indices,
                          2 * num_timesteps * loop_length[0] *
                          CORREALTION_NUM_TOP_SCORES *
                          CORREALTION_NUM_PIPES * 4)
