...
def correlate_dfe(data, size_timeseries, num_timeseries, correlations):
    ...
    try:
        ...
        actions_loadLMem = correlation_loadLMem_actions_t_struct(
            num_bursts, address_loop_length, address_in_mem_load)
        address_actions_loadLMem = client.send_correlation_loadLMem_actions_t(actions_loadLMem)
        client.correlation_loadLMem_run(engine, address_actions_loadLMem)
