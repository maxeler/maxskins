...
def correlate_dfe(data, size_timeseries, num_timeseries, correlations):
    ...
    try:
        ...
        client.max_get_offset_auto_loop_size(actions, "CorrelationKernel",
                                             "loopLength")
        client.max_queue_input(actions, "in_memLoad",
                               address_in_mem_load,
                               in_mem_load_size)
        ...
        client.max_queue_input(actions, "in_precalculations",
                               address_precalculations,
                               precalculations_size * 8)
        client.max_queue_input(actions, "in_variable_pair",
                               address_data_pairs,
                               data_pairs_size * 8)
        client.max_queue_output(actions, "out_correlation",
                                address_out_correlation,
                                out_correlation_size * 8)
        client.max_queue_output(actions, "out_indices",
                                address_out_indices,
                                out_indices_size * 4)
