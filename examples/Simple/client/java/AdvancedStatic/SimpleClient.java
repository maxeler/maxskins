...
import com.maxeler.Simple.Simple_actions_t_struct;
...
public final class SimpleClient {
  ...
  public static List<Double> simpleDfe(final int size,
    ...
    try {
      ...
      // Initialize maxfile
      startTime = System.nanoTime();
      final long maxfile = client.Simple_init();
      estimatedTime = (System.nanoTime() - startTime) / NUM_OF_NANO_SECONDS;
      ...
      // Action default
      startTime = System.nanoTime();
      Simple_actions_t_struct action = new Simple_actions_t_struct(
          size, addressDataIn, addressDataOut);
      final long addressAction = client.send_Simple_actions_t(action);
      client.Simple_run(engine, addressAction);
      estimatedTime = (System.nanoTime() - startTime) / NUM_OF_NANO_SECONDS;
